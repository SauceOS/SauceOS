...
echo "have your speekers turned up."
echo ""
...
echo
echo "Press enter when you're ready to continue."-c ${reset}
echo -en "\007"
read
echo ""
echo ""
...
echo -c ${blue}"***************************************************"' >> /mnt/gentoo/portage
...
echo 'echo "***************************************************"' >> /mnt/gentoo/portage
echo 'echo ""' >> /mnt/gentoo/portage
echo 'echo "Please press enter to continue"${reset}' >> /mnt/gentoo/portage
echo -en "\007"
