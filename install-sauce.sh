...
echo "on older systems"

echo "IMPORTANT: THIS WILL RESULT IN ALL EXISTING DATA BEING"
...
echo ""
echo ""
echo "VPN SETUP REQUIRED AT THIS POINT"
echo ""
...
echo "of the desktop."
echo ""
echo "IMPORTANT: In the event that you are not connected to"
echo "the VPN, we would strongly advise you to quit (control-C)" "and try the installation again, or understand that your use of"
echo "privacy networks and cryptocurrency are viewable on the"
echo "clearnet for others to see."
echo ""
echo ""
echo "HIT ENTER NOW TO FORMAT THE HARD DRIVE AND START"
echo "THE INSTALL OF SAUCE-OS"
read
echo ""
echo ""
echo ""
