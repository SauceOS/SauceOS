...
echo ""
echo -e "${green}***********************************************"
echo "**** SAUCE-OS - Version: v1.0.0.1-ketchup ****"
echo "**********************************************"
echo ""
...
echo -c "from //home/redcore/Documents to //etc/wireguard${reset}"
mkdir //etc/wireguard/
mv /home/redcore/Downloads/wgvpn.conf /etc/wireguard/
echo ""
echo -c "${green}You may replace the contents of the file with any other"
